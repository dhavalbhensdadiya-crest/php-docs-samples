...
// [START secretmanager_remove_regional_secret_expiration]
...
/**
 * Remove the expiration TTL from a regional secret.
 *
 ...
 */
function remove_regional_secret_expiration(string $projectId, string $locationId, string $secretId): void
{
...
// [END secretmanager_remove_regional_secret_expiration]
