 ...
 * @param string $ttl        Your Version Destroy Ttl (e.g. 86400)
 */
function create_secret_with_expiration(string $projectId, string $secretId, string $ttl): void
{
