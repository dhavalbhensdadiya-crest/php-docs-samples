...
// [START secretmanager_remove_secret_expiration]
...
/**
 * Remove the TTL (expiration) from a secret.
 *
 * @param string $projectId Your Google Cloud Project ID (e.g. 'my-project')
 * @param string $secretId  Your secret ID (e.g. 'my-secret')
 */
function remove_secret_expiration(string $projectId, string $secretId): void
{
...
// [END secretmanager_remove_secret_expiration]
